...
SELECT 
  date_trunc('month',pg.reported_date) AS month
  ,district
  ,shehia
...
CREATE UNIQUE INDEX IF NOT EXISTS agg_outcome_pregnancy_month_shehia ON agg_outcome_pregnancy USING btree (month, shehia,district);
-- Permissions
