...
SELECT 
    ...
    ,SUM((sex='female')::INT AND retired IS NULL) as supervisor_female_now
...
CREATE UNIQUE INDEX IF NOT EXISTS agg_district_supervisor_key ON agg_district_supervisor_count USING btree (month,district);
-- Permissions
