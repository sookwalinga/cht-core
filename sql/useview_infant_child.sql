...
(
  SELECT
    ...
    NULLIF(COALESCE(doc #>> '{fields,small_baby_breastfeeding,small_baby_time_breastfeed}',doc #>> '{fields,essential_newborn_breastfeeding,time_to_breastfeed}'),'') AS time_to_breastfeed,
