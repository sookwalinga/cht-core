...
(
  SELECT
    ...
    COALESCE(doc #>> '{fields,neonatal_danger_signs,neonatal_not_crying}',doc #>> '{fields,neonatal_danger_signs_secondary,neonatal_not_crying}')::BOOLEAN AS neonatal_not_crying,
    COALESCE(doc #>> '{fields,neonatal_danger_signs,neonatal_blue_color}',doc #>> '{fields,neonatal_danger_signs_secondary,neonatal_blue_color}')::BOOLEAN AS neonatal_blue_color,
    ...
    COALESCE(doc #>> '{fields,neonatal_danger_signs_secondary,neonatal_cold}', doc #>> '{fields,neonatal_danger_signs,neonatal_cold}')::BOOLEAN AS neonatal_cold,
    COALESCE(doc #>> '{fields,neonatal_danger_signs_secondary,neonatal_yellow_pale_palms}',doc #>> '{fields,neonatal_danger_signs,neonatal_yellow_pale_palms}')::BOOLEAN AS neonatal_yellow_pale_palms,
    COALESCE(doc #>> '{fields,neonatal_danger_signs_secondary,neonatal_no_movement}', doc #>> '{fields,neonatal_danger_signs,neonatal_no_movement}')::BOOLEAN AS neonatal_no_movement,
    COALESCE(doc #>> '{fields,neonatal_danger_signs_secondary,neonatal_cord_bleeding}', doc #>> '{fields,neonatal_danger_signs,neonatal_cord_bleeding}')::BOOLEAN AS neonatal_cord_bleeding,
    COALESCE(doc #>> '{fields,neonatal_danger_signs_secondary,neonatal_diarrhea}', doc #>> '{fields,neonatal_danger_signs,neonatal_diarrhea}')::BOOLEAN AS neonatal_diarrhea,
    ...
    COALESCE(doc #>> '{fields,child_danger_signs,child_severe_diarrhea}', doc #>> '{fields,child_danger_signs,child_diarrhea}')::BOOLEAN AS child_severe_diarrhea,
    NULLIF(doc #>> '{fields,child_danger_signs,refer_child_danger_sign_flag}', '')::BOOLEAN AS refer_child_danger_sign_flag,
    COALESCE(doc #>> '{fields,child_other_danger_signs,child_drink_below_6_months}', doc #>> '{fields,child_danger_signs,child_drink_below_6_months}')::BOOLEAN AS child_drink_below_6_months,
    COALESCE(doc #>> '{fields,child_other_danger_signs,child_drink_6_months_to_2_years}',doc #>> '{fields,child_danger_signs,child_drink_6_months_to_2_years}')::BOOLEAN AS child_drink_6_months_to_2_years,
    COALESCE(doc #>> '{fields,child_other_danger_signs,child_drink_above_2_years}',doc #>> '{fields,child_danger_signs,child_drink_above_2_years}')::BOOLEAN AS child_drink_above_2_years,
    COALESCE(doc #>> '{fields,child_other_danger_signs,child_coughing}',doc #>> '{fields,child_danger_signs,child_coughing}')::BOOLEAN AS child_coughing,
    COALESCE(doc #>> '{fields,child_other_danger_signs,child_cold}',doc #>> '{fields,child_danger_signs,child_cold}')::BOOLEAN AS child_cold,
    COALESCE(doc #>> '{fields,child_other_danger_signs,child_skin_boils}',doc #>> '{fields,child_danger_signs,child_skin_boils}')::BOOLEAN AS child_skin_boils,
    ...
    NULLIF(doc #>> '{fields,essential_newborn_breastfeeding,breastfeeding,currently_breastfeeding}', '')::BOOLEAN AS currently_breastfeeding,
    NULLIF(doc #>> '{fields,essential_newborn_breastfeeding,breastfeeding,exclusively_breastfeeding}', '')::BOOLEAN AS exclusively_breastfeeding,
    ...
    NULLIF(doc #>> '{fields,small_baby_breastfeeding,small_baby_ever_breastfed}', '')::BOOLEAN AS small_baby_ever_breastfed,
    doc #>> '{fields,small_baby_breastfeeding,small_baby_time_breastfeed}' AS small_baby_time_breastfeed,
    NULLIF(doc #>> '{fields,small_baby_breastfeeding,small_baby_currently_breastfeeding}', '')::BOOLEAN AS small_baby_currently_breastfeeding,
    doc #>> '{fields,small_baby_breastfeeding,small_baby_times_breastfed_daily}' AS small_baby_times_breastfed_daily,
    NULLIF(doc #>> '{fields,small_baby_breastfeeding,small_baby_breastfeed_exclusively}', '')::BOOLEAN AS small_baby_breastfeed_exclusively,
    NULLIF(doc #>> '{fields,small_baby_breastfeeding,small_baby_breastfeed_well}', '')::BOOLEAN AS small_baby_breastfeed_well,
