...
(
  SELECT
    ...
    sum((was_child_left_alone_more_than_1h > 0 OR was_child_left_in_care_of_other_child_more_than_1h > 0)::INT) AS left_alone,
    sum((coalesce(was_child_left_alone_more_than_1h, was_child_left_in_care_of_other_child_more_than_1h))::INT) AS left_alone_denominator,
...
CREATE UNIQUE INDEX IF NOT EXISTS moh_district_month_shehia_agg_ecd ON moh_agg_ecd USING btree (district, shehia, reported_month, disaggregation, disaggregation_value);
