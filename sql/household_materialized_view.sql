...
------------------------------------------------------------
CREATE MATERIALIZED VIEW household AS 
(
	SELECT
		doc ->> '_id' AS _id,
        doc ->> '_rev' AS _rev,
...
CREATE UNIQUE INDEX IF NOT EXISTS household_reported_date_created_by_uuid ON household USING btree (reported_date, chv_uuid, _id);
-- Permissions
