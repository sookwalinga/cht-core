...
describe('Tasks reducer', () => {
  ...
  describe('setTasksList', () => {
    ...
    it.only('should sort provided tasks by due date', () => {
      const tasks = [
    ...
    it.only('should sort provided tasks by priority and due date', () => {
      const tasks = [
        ...
        { _id: 'task2', dueDate: 500, priority: 3, state: 'Ready', field: 2 },
        { _id: 'task3', dueDate: 250, priority: 1, state: 'Ready', field: 3 },
        { _id: 'task4', dueDate: 250, priority: 2, state: 'Ready', field: 4 },
        {
          _id: 'task5',
          dueDate: 899,
          priority: undefined,
        ...
        { _id: 'task7', dueDate: -100, priority: 1, state: 'Ready', field: 7 },
        { _id: 'task8', dueDate: -100, priority: 2, state: 'Ready', field: 8 },
        {
          _id: 'task9',
          dueDate: undefined,
          priority: 3,
