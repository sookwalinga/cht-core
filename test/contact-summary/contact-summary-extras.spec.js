const {
  ...
  "parent":{"_id":"e2d6ed93-dc45-4c41-9bc8-64dddb52a21c",
  ...
  "type":"person",
  "parent":{"_id":"c84c3b37-9f39-436f-81cf-14c10e03c637",
  "parent":{"_id":"e2d6ed93-dc45-4c41-9bc8-64dddb52a21z",
  "parent":{"_id":"498c451e-1f1f-41ef-b5c0-105580da292f"}}},
  "patient_id":"30834",
  ...
  describe('isCHWPerformanceThisMonth function', function () {
    ...
    it('should return length of array as zero for user with targetDoc without targets', function () {
      ...
      expect(isCHWPerformanceThisMonth(targetDocument2,c2).length).to.eq(0)
  
    });
  
    it('should return empty for user without a targetDoc ', function () {
  
      expect(isCHWPerformanceThisMonth(targetDocument3,c3)).to.be.empty
    });
